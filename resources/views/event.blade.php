...
@section('content')
    <section class="event-img">
        <img src="/uploads/images/{{$event->cover}}" class="event-img__bg">
        <img src="/uploads/images/{{$event->cover}}" class="event-img__img" alt="">
    </section>
    ...
    <section class="info-cont">
        <div class="center-wrap">
            ...
            <p class="info-cont__text">{{$event->description}}</p>
    ...
    <section class="trebovania">
        <div class="center-wrap">
            <h2 class="need__title">Условия сотрудничества</h2>
            <div class="content-trebovania">
                <div class="item-trebovania">
                    <div class="info-item">Оплачивается:<br>{{$event->payment}}</div>
                    <div class="info-item">Метод оплаты:<br>{{$event->payment_method}}</div>
