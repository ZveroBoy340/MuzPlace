...
@section('content')
    <h1 class="pt-5">Редактирование типа</h1>
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-body">
                        <form method="post" enctype="multipart/form-data" action="/mpadmin/skills/{{ $type->id }}/update">
                            @csrf
                                    ...
                                    <div class="details-contact">
                                        <div class="inputs__wrap">
                                            ...
                                            <div class="gender-radio">
                                                <input type="radio" id="accept" name="status" value="1" @if ($type->status  == 1) checked @endif >
                                                <label for="accept">Одобрен</label>
                                                <input type="radio" id="check" name="status" value="0" @if ($type->status  == 0) checked @endif >
