                        ...
                        @foreach ($data as $item => $key)
                            <div class="inputs__inputs" id="date-event_{{$item}}">
                                <div class="inputs__wrap">
                                    ...
                                    <input type="text" name="date[{{$item}}][]" class="date-input artiste datepicker-here" data-date="{{$item}}" value="{{$key[0]}}">
                                </div>
                                <div class="inputs__wrap">
                                    <p class="inputs__title">C</p>
                                    <input type="text" name="date[{{$item}}][]" class="date-input times" value="{{$key[1]}}">
                                </div>
                                <div class="inputs__wrap">
                                    <p class="inputs__title">До</p>
                                    <input type="text" name="date[{{$item}}][]" class="date-input times" value="{{$key[2]}}">
                                </div>
                                @if(!$loop->first)
