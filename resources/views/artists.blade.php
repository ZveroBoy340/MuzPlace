            ...
            <div class="artists__list">
                <div class="artist-item">
                    <div class="artist-item__img">
                        ...
                        <div><img src="images/artist.png" alt=""></div>
                    </div>
                    <div class="artist-item__info">
                        <div class="artist-item__type">музыкальная группа</div>
                        <h2 class="artist-item__title"><a href="/artist.html">Гитарный дуэт "Capriccio Duo"</a></h2>
                ...
                <!-- 						Заглушки вывести программисту после цикла, они правильно выравнивают последний ряд айтемов, если в последнем ряду стоит 1/2 айтема  -->
            </div>
        </div>
        </div>
    </section>
