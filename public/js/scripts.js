...
$("body").on("click",".event-page-2",function(e){
    var error = 0;
    if(!$('#name-event').val()) {
        $('.popup-message.error .popup-text').text('Проверьте корректность заполнения полей');
        $('.popup-message.error').show(500);
        $('#name-event').addClass('not_filled');
        error = 1;
    }
    /*if(!$('#description-event').val()) {
        $('.popup-message.error .popup-text').text('Проверьте корректность заполнения полей');
        $('.popup-message.error').show(500);
        $('#description-event').addClass('not_filled');
        error = 1;
    }*/
...
$("body").on("click",".not_filled",function(e){
...
$("body").on("click",".add_date_event.dates",function(e){
    ...
    $(".add_date_event.dates").before('<div class="inputs__inputs" id="date-event_'+event_element+'"> <div class="inputs__wrap"> <p class="inputs__title">Дата</p> <input type="text" value="00.00.0000" name="date['+event_element+'][]" class="date-input artiste datepicker-here" data-date="'+event_element+'"> </div> <div class="inputs__wrap"> <p class="inputs__title">C</p> <input type="text" name="date['+event_element+'][]" value="00:00" class="date-input times"> </div> <div class="inputs__wrap"> <p class="inputs__title">До</p> <input type="text" name="date['+event_element+'][]" value="00:00" class="date-input times"> </div> <span class="del_dates" data-number="'+event_element+'"></span> </div>');
